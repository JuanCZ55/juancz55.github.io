...
// Ingrese cuantas imagenes van al carrusel en canti y en que carpeta se encuentran en carpeta
let canti = 6;
const carpeta="../Imagenes/PS5/";
const imagenes = [];
for (let i = 1; i <= canti; i++) {
    imagenes.push(carpeta+"Imagen (" + i + ").jpg");
}
canti--;
